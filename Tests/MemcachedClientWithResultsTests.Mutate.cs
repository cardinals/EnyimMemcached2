...
namespace Enyim.Caching.Tests
{
	public partial class MemcachedClientWithResultsTests
	{
		...
		public void When_Incrementing_Value_Result_Is_Successful()
		{
			...
			ShouldPass(client.Increment(key, 100, 10), 100);
			ShouldPass(client.Increment(key, 100, 10), 110);
		}
		...
		public void When_Decrementing_Value_Result_Is_Successful()
		{
			...
			ShouldPass(client.Decrement(key, 100, 10), 100);
			ShouldPass(client.Decrement(key, 100, 10), 90);
		}
	}
}
