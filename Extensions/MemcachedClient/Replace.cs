...
namespace Enyim.Caching.Memcached
{
	...
	{
		public static Task<IOperationResult> ReplaceAsync(this IMemcachedClient self, string key, object value, ulong cas = Protocol.NO_CAS)
		{
		...
		public static IOperationResult Replace(this IMemcachedClient self, string key, object value, ulong cas = Protocol.NO_CAS)
		{
