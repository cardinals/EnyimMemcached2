...
namespace Enyim.Caching.Memcached
{
	...
	{
		public static Task<IOperationResult> StoreAsync(this IMemcachedClientWithResults self, StoreMode mode, string key, object value, Expiration expiration)
		{
		...
		public static IOperationResult Store(this IMemcachedClientWithResults self, StoreMode mode, string key, object value, ulong cas = Protocol.NO_CAS)
		{
			return self.StoreAsync(mode, key, value, Expiration.Never, cas).RunAndUnwrap();
		}

		public static IOperationResult Store(this IMemcachedClientWithResults self, StoreMode mode, string key, object value, Expiration expiration, ulong cas = Protocol.NO_CAS)
		{
