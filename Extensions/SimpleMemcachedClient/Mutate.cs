...
namespace Enyim.Caching.Memcached
{
	public static partial class SimpleMemcachedClientExtensions
	{
		...
		public static ulong Mutate(this ISimpleMemcachedClient self, MutationMode mode, string key, ulong delta = Protocol.MUTATE_DEFAULT_DELTA, ulong defaultValue = Protocol.MUTATE_DEFAULT_VALUE)
		{
