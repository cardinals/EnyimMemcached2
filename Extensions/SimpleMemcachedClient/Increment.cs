...
namespace Enyim.Caching.Memcached
{
	public static partial class SimpleMemcachedClientExtensions
	{
		...
		public static Task<ulong> IncrementAsync(this ISimpleMemcachedClient self, string key, Expiration expiration, ulong delta = Protocol.MUTATE_DEFAULT_DELTA, ulong defaultValue = Protocol.MUTATE_DEFAULT_VALUE)
		{
			return self.MutateAsync(MutationMode.Increment, key, expiration, delta, defaultValue);
		}

		public static ulong Increment(this ISimpleMemcachedClient self, string key, ulong delta = Protocol.MUTATE_DEFAULT_DELTA, ulong defaultValue = Protocol.MUTATE_DEFAULT_VALUE)
		{
